...
//                .fetchOne();
    ...
    /**
     * 회원과 팀을 조인하면서, 팀 이름이 teamA인 팀만 조인, 회원은 모두 조회 (left outer join)
     *
     * JPQL
     * select m, t
     * from Member m
    ...
    public void fetchJoinNo() throws Exception {
        ...
        // 주의!
        // 페치 조인을 테스트할 때는 영속성 컨텍스트를 깔끔하게 비워주어야 정확한 테스팅이 가능하다.
        em.flush();
        em.clear();
        ...
        // lazy loading 이기 때문에 아직 초기화되지 않음
    ...
    @Test
    public void complexOrderCase() throws Exception {
...
//    @Commit
    public void bulkUpdate() throws Exception {
        ...
        // 영속성 컨텍스트 초기화
        // 수정 후, DB의 값과 영속성 컨텍스트의 값이 달라지므로 초기화하는 것이 안전하다.
        em.flush();
        em.clear();
